...
public class Player extends ActionEntities {
    ...
    public static final String PLAYER_KEY = "wyvern";
...
//            scheduler.unscheduleAllEvents(target);
            ...
            Point nextPos = wyvern.nextPositionPlayer(world, target.getPosition());
    ...
    private Point nextPositionPlayer(WorldModel world, Point destPos)
    {
            ...
            EventScheduler scheduler)
    {
        ...
        if (wyvernTarget.isPresent()) {
            ...
            if (Player.moveToPlayer( this, world, wyvernTarget.get(), scheduler)) {
